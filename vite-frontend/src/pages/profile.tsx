...
export default function ProfilePage() {
  ...
  const adminMenuItems: MenuItem[] = [
    {
      path: "/limit",
      label: getPanelLabel("/limit", "profile"),
      icon: (
    ...
    {
      path: "/user",
      label: getPanelLabel("/user", "profile"),
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
    ...
    {
      path: "/config",
      label: getPanelLabel("/config", "profile"),
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
          <path
            fillRule="evenodd"
    ...
    {
      path: "/operations",
      label: getPanelLabel("/operations", "profile"),
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
      ...
      description: "备份、恢复与支持包",
    },
    {
      path: "/audit",
      label: getPanelLabel("/audit", "profile"),
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
          <path
            fillRule="evenodd"
    ...
    <div className="px-3 lg:px-6 py-4 lg:py-6 flex flex-col h-full space-y-4">
      ...
      <div className="space-y-6 flex-1">
          ...
          <CardBody className="p-4">
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              ...
              {isAdmin &&
                adminMenuItems.map((item) => (
                  ...
                  >
                    ...
                    <span className="text-[11px] panel-muted text-center mt-1 line-clamp-2">
                      {item.description}
                    </span>
                  </button>
                ))}
              ...
              >
                ...
                <span className="text-[11px] panel-muted text-center mt-1">
                  更新账号与凭证
                </span>
              </button>
        ...
        <div className="fixed inset-x-0 bottom-20 text-center py-4">
          ...
          <p className="text-xs panel-muted mt-1">v{siteConfig.version}</p>
        </div>
      </div>
