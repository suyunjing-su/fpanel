...
export default function H5Layout({
  ...
  const tabItems: TabItem[] = [
    {
      path: '/dashboard',
      label: getPanelLabel('/dashboard', 'h5'),
      icon: (
    ...
    {
      path: '/forward',
      label: getPanelLabel('/forward', 'h5'),
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
    ...
    {
      path: '/profile',
      label: getPanelLabel('/profile', 'h5'),
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
  ...
  return (
    <div className="flex flex-col min-h-screen bg-transparent">
      ...
      {/* 底部Tabbar */}
      <nav className="bg-white/95 dark:bg-slate-950/95 border-t border-slate-200 dark:border-slate-700 h-16 safe-bottom flex-shrink-0 flex items-center justify-around px-2 fixed bottom-0 left-0 right-0 z-30 backdrop-blur-lg">
